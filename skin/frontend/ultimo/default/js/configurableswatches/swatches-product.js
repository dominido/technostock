...
Product.ConfigurableSwatches.prototype = {
    ...
    attachOptEvents: function(opt) {
        ...
        this.swatchSelect = opt.attr._e.optionSelect;

        if(typeof this.swatchSelect.next('.chosen-container') !== "undefined") {
            this.swatchSelect.next('.chosen-container').remove();
            if(this.swatchSelect.visible()) {
                new Chosen(this.swatchSelect,{disable_search_threshold:10});
            }
        }
        if(typeof this.swatchSelect.next('.chosen-container') === "undefined" && this.swatchSelect.visible()) {
            new Chosen(this.swatchSelect,{disable_search_threshold:10});
        }
    },
    /**
