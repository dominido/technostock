...
class Infortis_Ultimo_Helper_Template_Page_Html_Header extends Mage_Core_Helper_Abstract
{
	...
	public function __construct()
	{
		...
		$this->_pos['account']		= $this->_theme->getCfg('header/account_position');
	}
	...
	public function getDisplayedInHeaderBlock()
	{
		...
		if ($this->_pos['account'] === 'userMenu' || $this->_pos['account'] === 'mainMenu')
		{
			$display['account'] = FALSE;
		}
	...
	public function getMoveBelowSkipLinks()
	{
		...
		if ($this->_pos['account'] === 'topRight_1' || $this->_pos['account'] === 'mainMenu')
		{
			$move['account'] = TRUE;
		}
