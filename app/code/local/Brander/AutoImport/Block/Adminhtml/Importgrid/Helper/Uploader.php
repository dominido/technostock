 ...
 */
class Brander_AutoImport_Block_Adminhtml_Importgrid_Helper_Uploader extends Mage_Adminhtml_Block_Widget
{
    ...
    public function __construct()
    {
        ...
        $this->getConfig()->setFilters(array(
            'catalog' => array(
                'label' => Mage::helper('adminhtml')->__('Import Files (.csv, .xml, .txt)'),
                'files' => array('*.csv', '*.xml', '*.txt')
            ),
        ));
    }
