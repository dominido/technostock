...
class Brander_AutoImport_Block_Adminhtml_Stages_Stagethree_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('stagethreeGrid');
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('autoimport/source_stages_stageThree')->getGridCollection();
