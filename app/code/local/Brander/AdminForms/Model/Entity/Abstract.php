...
abstract class Brander_AdminForms_Model_Entity_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    /**
    ...
    {
        return Brander_AdminForms_Model_Abstract::DEFAULT_STORE_ID;
    }
     ...
     *
     * @param   Brander_AdminForms_Model_Block $object
     ...
     * @param mixed $value
     * @return Brander_AdminForms_Model_Entity_Abstract
     */
...
//        return $this;
    ...
    {
        $select = $this->_getReadAdapter()->select()
            ->from($this->getEntityTable(),array('entity_id','entity_type_id','attribute_set_id','parent_id','created_at','updated_at'))
...
//echo "<pre>".print_r($allStores ,1)."</pre>"; exit;
    ...
    public function getAttributeRawValue($entityId, $attribute, $store)
    {
        ...
        foreach ($attribute as $_attribute) {
            /* @var $attribute Mage_Eav_Entity_Attribute */
