<?php
class Brander_SearchAutocomplete_Helper_Data extends Mage_Core_Helper_Abstract {
    
    const XML_SEARCHAUTOCOMPLETE_ENABLED = 'brander_autocomplete/searchautocomplete/enabled';
    const XML_SEARCHAUTOCOMPLETE_HIGHLIGHTING_ENABLED = 'brander_autocomplete/searchautocomplete/highlighting_enabled';
    const XML_SEARCHAUTOCOMPLETE_SEPARATOR_ENABLED = 'brander_autocomplete/searchautocomplete/separator_enabled';
    
    const XML_SEARCHAUTOCOMPLETE_SUGGESTED_SEARCHES = 'brander_autocomplete/searchautocomplete/suggested_searches';
    const XML_SEARCHAUTOCOMPLETE_SUGGESTED_SEARCHES_RESULTS = 'brander_autocomplete/searchautocomplete/suggested_searches_results';

    const XML_SEARCHAUTOCOMPLETE_SEARCH_PRODUCTS = 'brander_autocomplete/searchautocomplete/search_products';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_IMAGE_SIZE = 'brander_autocomplete/searchautocomplete/product_image_size';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULTS = 'brander_autocomplete/searchautocomplete/product_search_results';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULTS_SORT_ORDER = 'brander_autocomplete/searchautocomplete/product_search_results_sort_order';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SEARCH_RESULT_FIELDS = 'brander_autocomplete/searchautocomplete/product_search_result_fields';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_SHORT_DESCRIPTION_SIZE = 'brander_autocomplete/searchautocomplete/product_short_description_size';
    const XML_SEARCHAUTOCOMPLETE_PRODUCT_TITLE_SIZE = 'brander_autocomplete/searchautocomplete/product_title_size';
    
    const XML_SEARCHAUTOCOMPLETE_SEARCH_CATEGORIES = 'brander_autocomplete/searchautocomplete/search_categories';
    const XML_SEARCHAUTOCOMPLETE_CATEGORY_SEARCH_RESULTS = 'brander_autocomplete/searchautocomplete/category_search_results';
    
    const XML_SEARCHAUTOCOMPLETE_SEARCH_CMS = 'brander_autocomplete/searchautocomplete/search_cms';
    const XML_SEARCHAUTOCOMPLETE_CMS_SEARCH_RESULT_FIELDS = 'brander_autocomplete/searchautocomplete/cms_search_result_fields';

    const XML_SEARCHAUTOCOMPLETE_SEARCH_BLOG = 'brander_autocomplete/searchautocomplete/search_blog';

    const XML_SEARCHAUTOCOMPLETE_SHOW_PRODUCT_RESULTS_GROUPED_BY_CATEGORIES = 'brander_autocomplete/searchautocomplete/show_product_results_grouped_by_categories';
    ...
    public function isSearchCmspro() {
        return Mage::getStoreConfigFlag('brander_autocomplete/searchautocomplete/search_cmspro') && (string)Mage::getConfig()->getModuleConfig('MW_Cmspro')->active == 'true';
    }
    
    public function getCmsproSearchResultFields() {
        return explode(',', Mage::getStoreConfig('brander_autocomplete/searchautocomplete/search_cmspro_result_fields'));
    }
    public function getPopUpDelay() {
        return (int)Mage::getStoreConfig('brander_autocomplete/searchautocomplete/popup_delay');
    }
    ...
    public function sanitizeContent($page) {
        ...
        $text = preg_replace_callback('@{{.*?}}@si','Brander_SearchAutocomplete_Helper_Data::loadWidget', $text);
