...
class Brander_SearchAutocomplete_AjaxController extends Mage_CatalogSearch_AjaxController {
    ...
    public function suggestAction() { 
        ...
        if (Mage::getConfig()->getModuleConfig('Brander_XSearch')->is('active', true)) {
