 ...
 */
class Brander_ProductBanners_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'Brander_ProductBanners';
    const ENTITY        = 'brander_productbanners_eav_attribute';

    protected $_eventPrefix = 'brander_productbanners_entity_attribute';
    ...
    {
        $this->_init('brander_productbanners/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('brander_productbanners')->__('This attribute is not deletable')
            );
        }
