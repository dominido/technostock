 ...
 */
class Brander_ProductBanners_Block_Adminhtml_Banner_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Brander_ProductBanners_Block_Adminhtml_Banner_Edit_Tab_Product
    ...
    protected function _prepareCollection()
    {
        ...
        if ($this->getBanner()->getId()) {
            $constraint = '{{table}}.banner_id='.$this->getBanner()->getId();
        } else {
            $constraint = '{{table}}.banner_id=0';
        }
    ...
    {
        $products = array();
        $selected = Mage::registry('current_banner')->getSelectedProducts();
     ...
     *
     * @access public
     * @param Brander_ProductBanners_Model_Product
     * @return string
