 ...
 */
class Brander_ProductBanners_Block_Adminhtml_Banner_Edit_Tab_Attributes extends Mage_Adminhtml_Block_Widget_Form
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $form->setDataObject(Mage::registry('current_banner'));
        $fieldset = $form->addFieldset(
            'info',
            array(
                'legend' => Mage::helper('brander_productbanners')->__('Banner Information'),
                'class' => 'fieldset-wide',
            )
        );
        $attributes = $this->getAttributes();
        foreach ($attributes as $attribute) {
            $attribute->setEntity(Mage::getResourceModel('brander_productbanners/banner'));
        }
        $this->_setFieldset($attributes, $fieldset, array());
        $formValues = Mage::registry('current_banner')->getData();
    ...
    protected function _prepareLayout()
    {
        ...
        Varien_Data_Form::setFieldsetElementRenderer(
            $this->getLayout()->createBlock('brander_productbanners/adminhtml_productbanners_renderer_fieldset_element')
        );
    }
    ...
    protected function _getAdditionalElementTypes()
    {
        return array(
            'file'     => Mage::getConfig()->getBlockClassName(
                'brander_productbanners/adminhtml_banner_helper_file'
            ),
            'image'    => Mage::getConfig()->getBlockClassName(
                'brander_productbanners/adminhtml_banner_helper_image'
            ),
