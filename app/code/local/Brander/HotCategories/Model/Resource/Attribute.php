 ...
 */
class Brander_HotCategories_Model_Resource_Attribute extends Mage_Eav_Model_Resource_Entity_Attribute
{
    /**
     ...
     * @return  Brander_HotCategories_Model_Resource_Attribute
     */
