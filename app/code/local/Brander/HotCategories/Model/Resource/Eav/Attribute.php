 ...
 */
class Brander_HotCategories_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'Brander_HotCategories';
    const ENTITY        = 'brander_hotcategories_eav_attribute';

    protected $_eventPrefix = 'brander_hotcategories_entity_attribute';
    ...
    {
        $this->_init('brander_hotcategories/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('brander_hotcategories')->__('This attribute is not deletable')
            );
        }
