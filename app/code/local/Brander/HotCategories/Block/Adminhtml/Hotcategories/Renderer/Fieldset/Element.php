 ...
 */
class Brander_HotCategories_Block_Adminhtml_HotCategories_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('brander_hotcategories/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Brander_HotCategories_Model_Resource_Eav_Attribute
     */
     ...
     *
     * @access public
     * @return Brander_HotCategories_Block_Adminhtml_HotCategories_Renderer_Fieldset_Element
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('brander_hotcategories')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('brander_hotcategories')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('brander_hotcategories')->__('[STORE VIEW]');
        }
        return $html;
    }
