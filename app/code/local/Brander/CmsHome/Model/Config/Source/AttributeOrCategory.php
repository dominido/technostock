 ...
 */
class Brander_CmsHome_Model_Config_Source_AttributeOrCategory
{

	const BRANDER_BY_ATTRIBUTE 	= 0;
	const BRANDER_BY_CATEGORY 	= 1;
	const BRANDER_BY_ATTRIBUTE_AND_CATEGORY 	= 2;
