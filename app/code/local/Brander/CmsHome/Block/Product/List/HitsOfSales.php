 ...
 */
class Brander_CmsHome_Block_Product_List_HitsOfSales extends Mage_Catalog_Block_Product_List
{
	...
	protected function _prepareCollectionAndCache()
	{
		...
		$this->_collectionCount = count($ids);
		if ($this->_collectionCount) {
