 ...
 */
class Brander_UnitopBlog_Model_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE       = 0;
    const SCOPE_GLOBAL      = 1;
    const SCOPE_WEBSITE     = 2;

    const MODULE_NAME       = 'Brander_UnitopBlog';
    const ENTITY            = 'brander_unitopblog_eav_attribute';
     ...
     * @var string
     */
    protected $_eventPrefix = 'brander_unitopblog_entity_attribute';
    ...
    {
        $this->_init('brander_unitopblog/attribute');
    }
