 ...
 */
class Brander_UnitopBlog_Model_Resource_Post_Comment_Post_Collection extends Brander_UnitopBlog_Model_Resource_Post_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('brander_unitopblog/post_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('brander_unitopblog/post_comment');
