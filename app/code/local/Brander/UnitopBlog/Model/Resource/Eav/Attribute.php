 ...
 */
class Brander_UnitopBlog_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('brander_unitopblog')->__('This attribute is not deletable')
            );
        }
