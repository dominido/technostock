 ...
 */
class Brander_UnitopBlog_Block_Adminhtml_UnitopBlog_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('brander_unitopblog/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Brander_UnitopBlog_Model_Resource_Eav_Attribute
     ...
     *
     * @access public
     * @return Brander_UnitopBlog_Block_Adminhtml_UnitopBlog_Renderer_Fieldset_Element
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('brander_unitopblog')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('brander_unitopblog')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('brander_unitopblog')->__('[STORE VIEW]');
        }
        return $html;
    }
