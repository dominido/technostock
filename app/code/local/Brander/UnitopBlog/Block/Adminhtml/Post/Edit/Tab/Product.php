 ...
 */
class Brander_UnitopBlog_Block_Adminhtml_Post_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return Brander_UnitopBlog_Block_Adminhtml_Post_Edit_Tab_Product
     ...
     *
     * @access public
     * @param Brander_UnitopBlog_Model_Product
     * @return string
