 ...
 */
class Brander_UnitopBlog_Block_Adminhtml_Post_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
     * Adding product form elements for editing attribute
     *
     * @access protected
     * @return Brander_UnitopBlog_Block_Adminhtml_Post_Attribute_Edit_Tab_Main
    ...
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent(
            'brander_unitopblog_adminhtml_post_attribute_edit_prepare_form',
            array(
                'form'      => $form,
