 ...
 */
class Brander_UnitopBlog_Block_Adminhtml_Postscategory_Helper_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('brander_unitopblog/postscategory')->getFileBaseUrl() . $url;
            }
