 ...
 */
class Brander_UnitopBlog_Post_Customer_CommentController extends Mage_Core_Controller_Front_Action
{
    /**
     * Action predispatch
    ...
    public function indexAction()
    {
        ...
        if ($navigationBlock = $this->getLayout()->getBlock('customer_account_navigation')) {
            $navigationBlock->setActive('brander_unitopblog/post_customer_comment/');
        }
    ...
    public function viewAction()
    {
        ...
        $comment = Mage::getModel('brander_unitopblog/post_comment')->load($commentId);
        if (!$comment->getId() ||
            $comment->getCustomerId() != Mage::getSingleton('customer/session')->getCustomerId() ||
            $comment->getStatus() != Brander_UnitopBlog_Model_Post_Comment::STATUS_APPROVED) {
