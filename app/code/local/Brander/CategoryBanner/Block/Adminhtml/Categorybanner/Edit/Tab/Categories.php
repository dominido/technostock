 ...
 */
/**
 * categorybanner - categories relation edit block
 *
 * @category    Brander
 * @package     Brander_CategoryBanner
 * @author      Ultimate Module Creator
 */
class Brander_CategoryBanner_Block_Adminhtml_Categorybanner_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('brander_categorybanner/categorybanner/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited category image
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the category image is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getCategorybanner()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param Brander_CategoryBanner_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current category image)
     *
     * @return array
     */
