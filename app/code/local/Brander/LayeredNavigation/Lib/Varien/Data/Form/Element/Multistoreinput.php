...
class Brander_LayeredNavigation_Lib_Varien_Data_Form_Element_Multistoreinput extends Varien_Data_Form_Element_Abstract
{
    ...
    public function getElementHtml()
    {
        ...
        foreach (Mage::helper('brander_layerednavigation')->getStores() as $_store) {
