...
class Brander_LayeredNavigation_Helper_Image extends Mage_Catalog_Helper_Image
{
    ...
    protected function computeRequestConfigurableMap()
    {
        ...
        $configurableCodes = explode(",", trim(Mage::getStoreConfig('brander_layerednavigation/general/configurable_images')));
