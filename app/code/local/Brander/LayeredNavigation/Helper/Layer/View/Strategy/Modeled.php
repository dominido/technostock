...
abstract class Brander_LayeredNavigation_Helper_Layer_View_Strategy_Modeled extends Brander_LayeredNavigation_Helper_Layer_View_Strategy_Abstract
{
    ...
    protected function getFilterModel()
    {
        ...
        /** @var Brander_LayeredNavigation_Model_Filter $model */
