...
class Brander_LayeredNavigation_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function checkAddSwatches(){
        $moduleEnabled = Mage::helper('brander_layerednavigation')->isModuleEnabled('Mage_ConfigurableSwatches');
