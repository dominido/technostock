...
class Brander_LayeredNavigation_Block_Catalog_Layer_Filter_Stock extends Mage_Catalog_Block_Layer_Filter_Abstract
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('brander/layerednavigation/attribute.phtml');
        $this->_filterModelName = 'brander_layerednavigation/catalog_layer_filter_stock';
    }
    ...
    public function getPosition()
    {
    	...
    	return Mage::getStoreConfig('brander_layerednavigation/general/stock_filter_pos');
    }
