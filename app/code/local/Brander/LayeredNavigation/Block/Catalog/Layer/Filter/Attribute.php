...
/**
 * Class Brander_LayeredNavigation_Block_Catalog_Layer_Filter_Attribute
 * @method Mage_Catalog_Model_Resource_Eav_Attribute getAttributeModel()
 */
class Brander_LayeredNavigation_Block_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Block_Layer_Filter_Attribute
{
    public function getItemsAsArray()
    {
        ...
        foreach (parent::getItems() as $itemObject){
            ...
            if ($itemObject->getImage()){
                $item['image'] = Mage::getBaseUrl('media') . 'brander_layerednavigation/' . $itemObject->getImage();
            }

            if ($itemObject->getImageHover()) {
                $item['image_hover'] = Mage::getBaseUrl('media') . 'brander_layerednavigation/' . $itemObject->getImageHover();
            }

            $item['css'] = 'brander_layerednavigation-attr';
            ...
            {
                $item['css'] .= ' brander_layerednavigation-attr-inactive';
            }
    ...
    public function getItemsCount()
    {
        ...
        if (isset($v) && $this->getRequestValue() == trim(Mage::getStoreConfig('brander_layerednavigation/brands/attr'))){
        ...
        $showAll = !Mage::getStoreConfig('brander_layerednavigation/general/hide_one_value');
