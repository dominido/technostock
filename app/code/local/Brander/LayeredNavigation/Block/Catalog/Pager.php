...
class Brander_LayeredNavigation_Block_Catalog_Pager extends Mage_Page_Block_Html_Pager
{
    ...
    {
        if (!Mage::getStoreConfig('brander_layerednavigation/seo/prev_next')) {
            return;
        }
    ...
    public function getPreviousPageUrl()
    {
        ...
        if ($prevPageNum == 1) {
            $result = preg_replace('/\Wp=\d+/', '', $currentUrl);
        } else {
