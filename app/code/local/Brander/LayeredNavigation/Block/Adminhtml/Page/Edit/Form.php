 ...
 */
class Brander_LayeredNavigation_Block_Adminhtml_Page_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $model = Mage::registry('brander_layerednavigation_page');
