...
class Brander_LayeredNavigation_Block_Adminhtml_Value_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /** @var  Brander_LayeredNavigation_Model_Value */
    protected $model;
    ...
    protected function _prepareForm()
    {
        ...
        $this->model = Mage::registry('brander_layerednavigation_value');
    ...
    protected function prepareFieldsetMeta()
    {
        ...
        $fldMeta->addType('multistoreinput','Brander_LayeredNavigation_Lib_Varien_Data_Form_Element_Multistoreinput');
    ...
    protected function prepareFieldsetMain()
    {
        ...
        $fldMain->addType('multistoreinput','Brander_LayeredNavigation_Lib_Varien_Data_Form_Element_Multistoreinput');
        $fldMain->addType('multistoretext','Brander_LayeredNavigation_Lib_Varien_Data_Form_Element_Multistoretext');
    ...
    protected function prepareFieldsetProductView()
    {
        ...
        $note = new Varien_Data_Form_Element_Note(array(
            'text' => $this->__('This image will be displayed near the products having current attribute option selected. You need to perform some modifications in theme template, please see Layered Navigation User Guide on pages 16-17.'),
        ));
    ...
    private function getImageHtml($img)
    {
        ...
        if ($img){
            ...
            $html .= '<img src="'.Mage::getBaseUrl('media') . 'brander_layerednavigation/' . $img .'" />';
            $html .= '</p>';
        }
        return $html;
    }
