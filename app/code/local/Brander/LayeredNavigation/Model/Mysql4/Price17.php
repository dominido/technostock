...
class Brander_LayeredNavigation_Model_Mysql4_Price17 extends Mage_Catalog_Model_Resource_Layer_Filter_Price
{

    public $_maxMinPrice = null;

    /** @var Brander_LayeredNavigation_Helper_Data */
    protected $_dataHelper;

    protected function _construct()
    {
        parent::_construct();
        $this->_dataHelper = Mage::helper('brander_layerednavigation');
    }
