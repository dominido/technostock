...
// todo merge with 14? 
class Brander_LayeredNavigation_Model_Mysql4_Price13 extends Mage_CatalogIndex_Model_Mysql4_Price
{
    ...
    public function getFromToCount($filter, $ranges)
    {
        ...
        $countExpr  = new Zend_Db_Expr('COUNT(DISTINCT price_table_brander_layerednavigation.entity_id)');
    ...
    protected function _prepareSelect($filter, $clone=false, $baseSelect = null, $attribute=null)
    {
        ...
        if ($this->_price){ // after apply() function or getMaxInt()
            ...
            $tableName = 'price_table_brander_layerednavigation';
            $ret->joinLeft(
