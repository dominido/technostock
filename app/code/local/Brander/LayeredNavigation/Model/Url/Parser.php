...
class Brander_LayeredNavigation_Model_Url_Parser
{
    /** @var  string */
    protected $params;
    ...
    public function parseParams($params)
    {
        ...
        if ($this->params == Mage::getStoreConfig('brander_layerednavigation/seo/key')) {
            return array();
        }
    ...
    protected function prepareInitialData($params)
    {
        ...
        $optionChar = Mage::getStoreConfig('brander_layerednavigation/seo/option_char');
        if ($optionChar == '--') {
