 ...
 * @method Brander_LayeredNavigation_Model_Filter setDisplayType(int)
 */
class Brander_LayeredNavigation_Model_Filter extends Mage_Core_Model_Abstract
{
    public function _construct()
    {    
        $this->_init('brander_layerednavigation/filter');
    }
    ...
    public function getDisplayTypeOptionsSource()
    {
        ...
        $modelName = 'brander_layerednavigation/source_' . $sourceName;
