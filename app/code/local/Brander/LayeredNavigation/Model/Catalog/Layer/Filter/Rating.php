...
class Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Rating extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    {
        return Mage::helper('brander_layerednavigation')->__('Rating Filter');
    }
    ...
    protected function getLabelHtml($countStars)
    {
        ...
        $html = $block->setTemplate('brander/layerednavigation/rating.phtml')->toHtml();
        return $html;
    }
