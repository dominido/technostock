...
class Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Price_Price17ce extends Mage_Catalog_Model_Layer_Filter_Price
{
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
         ...
         */
        $isSlider = Mage::getStoreConfig('brander_layerednavigation/general/price_type') == Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Price::DT_SLIDER;
        $fromTo = Mage::getStoreConfig('brander_layerednavigation/general/price_from_to');
        ...
        /** @var Brander_LayeredNavigation_Helper_Attributes $attrHelper */
        $attrHelper = Mage::helper('brander_layerednavigation/attributes');
     ...
     *
     * @return Brander_LayeredNavigation_Model_Mysql4_Price17
     */
    protected function _getResource()
    {
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getSingleton('brander_layerednavigation/mysql4_price17');
        }
    ...
    {
        if (!Mage::getStoreConfig('brander_layerednavigation/general/use_custom_ranges')) {
