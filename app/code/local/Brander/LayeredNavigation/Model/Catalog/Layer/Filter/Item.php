...
/**
 * Class Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Item
 * @method int getCount()
 */
class Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Item extends Mage_Catalog_Model_Layer_Filter_Item
{
    public function getUrl()
    {
        Varien_Profiler::start('brander_layerednavigation_filter_item_url');
        ...
        Varien_Profiler::stop('brander_layerednavigation_filter_item_url');
        return $url;
    }
