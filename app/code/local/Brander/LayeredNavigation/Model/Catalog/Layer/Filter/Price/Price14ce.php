...
class Brander_LayeredNavigation_Model_Catalog_Layer_Filter_Price_Price14ce extends Mage_Catalog_Model_Layer_Filter_Price
{
    ...
    protected function _getResource()
    {
        if (is_null($this->_resource)) {
            $this->_resource = Mage::getModel('brander_layerednavigation/mysql4_price');
        }
