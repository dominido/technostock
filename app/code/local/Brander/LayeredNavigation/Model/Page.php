...
/**
 * @method Brander_LayeredNavigation_Model_Page setCond($serializedCond)
 * @method string getCond()
 * @method Brander_LayeredNavigation_Model_Page setCats($cats)
 * @method string getCats()
 * @method int getCmsBlockId
 * @method string getMetaDescr()
 * @method string getMetaKw()
 * @method string getMetaTitle()
 * @method Brander_LayeredNavigation_Model_Page setUrl(string $url)
 * @method string getTitle()
 * @method string getUrl()
 * @method boolean getUseCat()
 */
class Brander_LayeredNavigation_Model_Page extends Mage_Core_Model_Abstract
{
    ...
    {
        $strict = Mage::getStoreConfig('brander_layerednavigation/seo/page_match_strict');
    ...
    {
        $attributes = Mage::getModel('brander_layerednavigation/filter')->getResourceCollection()->addFrontendInput($attributeCode);
