 ...
 */
class Brander_OurContacts_Block_Adminhtml_OurContacts_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('brander_ourcontacts/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Brander_OurContacts_Model_Resource_Eav_Attribute
     */
     ...
     *
     * @access public
     * @return Brander_OurContacts_Block_Adminhtml_OurContacts_Renderer_Fieldset_Element
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('brander_ourcontacts')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('brander_ourcontacts')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('brander_ourcontacts')->__('[STORE VIEW]');
        }
        return $html;
    }
