 ...
 */
class Brander_OurContacts_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'Brander_OurContacts';
    const ENTITY        = 'brander_ourcontacts_eav_attribute';

    protected $_eventPrefix = 'brander_ourcontacts_entity_attribute';
    ...
    {
        $this->_init('brander_ourcontacts/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('brander_ourcontacts')->__('This attribute is not deletable')
            );
        }
