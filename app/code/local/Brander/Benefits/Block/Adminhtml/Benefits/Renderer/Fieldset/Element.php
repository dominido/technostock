 ...
 */
class Brander_Benefits_Block_Adminhtml_Benefits_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('brander_benefits/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return Brander_Benefits_Model_Resource_Eav_Attribute
     */
     ...
     *
     * @access public
     * @return Brander_Benefits_Block_Adminhtml_Benefits_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('brander_benefits')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('brander_benefits')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('brander_benefits')->__('[STORE VIEW]');
        }
        return $html;
    }
