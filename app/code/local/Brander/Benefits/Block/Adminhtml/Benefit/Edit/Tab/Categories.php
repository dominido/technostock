 ...
 */
class Brander_Benefits_Block_Adminhtml_Benefit_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('brander_benefits/benefit/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited benefit
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the benefit is linked to
     *
     * @access public
     * @return array
     */
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getBenefit()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param Brander_Benefits_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current benefit)
     *
     * @return array
     */
