 ...
 */
class Brander_Benefits_Model_Resource_Benefit_Category_Collection extends Mage_Catalog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('brander_benefits/benefit_category')),
