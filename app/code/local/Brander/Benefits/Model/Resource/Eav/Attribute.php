 ...
 */
class Brander_Benefits_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'Brander_Benefits';
    const ENTITY        = 'brander_benefits_eav_attribute';

    protected $_eventPrefix = 'brander_benefits_entity_attribute';
    ...
    {
        $this->_init('brander_benefits/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('brander_benefits')->__('This attribute is not deletable')
            );
        }
